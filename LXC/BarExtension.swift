...
extension UIColor {
    ...
    fileprivate struct AssociatedKeys {   // default is system attributes
        static var defNavBarBarTintColor: UIColor = kNavigationBarTintColor
        static var defNavBarTintColor: UIColor = UIColor.white//UIColor(red: 0, green: 0.478431, blue: 1, alpha: 1.0)
